...
public class OvsaTrvlLrnExpCreateManagedBean extends TemplateDataTableManagedBean<OvsaTrvlLrnExp, OvsaTrvlLrnExpService> implements FunctionCodeAware, DisplayControlAware {
	...
	// RE201800088_國外出差費用核銷費用明細總表新增資料欄位 EC0416 2018/5/9 start
	/**
	 * 在國外研修差旅費用資料 頁面按下[更新]按鈕
	 * 
	 * @return
	 */
	public String doReNewUSCurrency() {
		OvsaTrvlLrnExp exp = getUpdatingDataValue();
	...
	public String doDownloadAction() {
		...
		String realPath = FacesUtils.getRealPath();
		String path = realPath+"/kernel/gae/expapply/inputapplyform/ovsatrvllrnexp/ovsa_excel.xls";
		String fileName = "ovsa_excel.xls";
		try {
	...
	// RE201800088_國外出差費用核銷費用明細總表新增資料欄位 EC0416 2018/5/9 end
}